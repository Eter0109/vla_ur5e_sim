...
from vla_sim.simulation.scenes import SceneSpec

from .common import CameraConfig, controller_config
...
class UR5ePushEnv:
    ...
    def __init__(self, backend: Any, config: UR5ePushConfig | None = None) -> None:
        ...
        from vla_sim.simulation.contracts import PickPlaceObservationAdapter
