...
from vla_sim.simulation.dependencies import require_robosuite
...
from vla_sim.simulation.scenes import COLOR_PICK_COLORS, COLOR_PICK_TASK, SceneSpec

from .common import controller_config
from .objects import PrimitiveObjectConfig
from .pick_place import PickPlaceCameraConfig, _look_at_quaternion
...
def create_color_pick_backend(config: UR5eColorPickConfig | None = None) -> Any:
    ...
    backend = _configurable_color_pick_class()(
        ...
        controller_configs=controller_config(suite),
