...
MANIFESTS = {
    "push": ROOT / "configs/benchmarks/push_robust_development_nominal_v1.json",
    "pick_place": ROOT / "configs/benchmarks/pick_place_robust_development_nominal_v1.json",
    "color_pick": ROOT / "configs/benchmarks/color_pick_development_v1.json",
}
