param(
    ...
    [string]$Output = "outputs\pick_place_v2_native_bin\teacher_distill_transport_v5_3_600\seed1000",
    [int]$Steps = 600,
    [int]$BatchSize = 8,
    [int]$Seed = 1000
)
...
# v5.3: AuxiliarySampleWeight = 0.45, XYZLossWeight = 3.0, LR = 6e-7, Steps = 600
& (Join-Path $PSScriptRoot "train_smolvla.ps1") `
    ...
    -AuxiliarySampleWeight "0.45" -AuxiliaryPhaseGroups "transport" `
    ...
    -ChunkSize 16 -ActionSteps 8 -SaveFreq 150 -Seed $Seed `
    -XYZLossWeight 3.0 -RotationLossWeight 0 -GripperLossWeight 2.5 `
